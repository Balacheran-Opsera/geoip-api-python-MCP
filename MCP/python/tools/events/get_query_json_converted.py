...
def get_query_json(name: str, latitude: str, longitude: str, sw: str, query: str, filter: str, date_range: str, sort: str, elevation: str, facets: str, limit: str, offset: str) -> str:
    """
    Geographic API
    """
    try:
